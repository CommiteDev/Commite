<template>
  <div class="max-w-5xl mx-auto p-6 bg-white shadow-lg rounded-lg my-5">
    <h1 class="text-4xl font-bold mb-4">Privacy Policy</h1>
    <p class="text-sm text-gray-500 mb-4">Last updated: May 23, 2024</p>
    <p class="mb-4">
    ...
    <h2 class="text-3xl font-semibold mt-6 mb-4">Interpretation and Definitions</h2>
    <h3 class="text-2xl font-semibold mt-4 mb-2">Interpretation</h3>
    <p class="mb-4">
      The words of which the initial letter is capitalized have meanings defined
      under the following conditions. The following definitions shall have the
      same meaning regardless of whether they appear in singular or in plural.
    </p>
    <h3 class="text-2xl font-semibold mt-4 mb-2">Definitions</h3>
    ...
    <ul class="list-disc list-inside mb-4">
      ...
      <li class="mb-2">
        <strong>Application:</strong> refers to Commite, the software program
        provided by the Company.
      </li>
      <li class="mb-2">
        <strong>Company:</strong> (referred to as either &quot;the
        Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in
        this Agreement) refers to Commite.
      </li>
      <li class="mb-2">
      ...
      <li class="mb-2"><strong>Country:</strong> refers to: Turkey</li>
      <li class="mb-2">
      ...
      <li class="mb-2">
        <strong>Website:</strong> refers to Commite, accessible from
        <a
          href="http://www.commite.dev"
          rel="external nofollow noopener"
          target="_blank"
          class="text-blue-600 hover:underline"
          >http://www.commite.dev</a
        >
      </li>
      <li class="mb-2">
    ...
    <h2 class="text-3xl font-semibold mt-6 mb-4">Collecting and Using Your Personal Data</h2>
    <h3 class="text-2xl font-semibold mt-4 mb-2">Types of Data Collected</h3>
    <h4 class="text-xl font-semibold mt-4 mb-2">Personal Data</h4>
    <p class="mb-4">
    ...
    <h4 class="text-xl font-semibold mt-4 mb-2">Usage Data</h4>
    ...
    <h4 class="text-xl font-semibold mt-4 mb-2">Tracking Technologies and Cookies</h4>
    <p class="mb-4">
    ...
    <h3 class="text-2xl font-semibold mt-6 mb-2">Use of Your Personal Data</h3>
    ...
    <h3 class="text-2xl font-semibold mt-6 mb-2">Retention of Your Personal Data</h3>
    <p class="mb-4">
    ...
    <h3 class="text-2xl font-semibold mt-6 mb-2">Transfer of Your Personal Data</h3>
    <p class="mb-4">
    ...
    <h3 class="text-2xl font-semibold mt-6 mb-2">Delete Your Personal Data</h3>
    <p class="mb-4">
    ...
    <h3 class="text-2xl font-semibold mt-6 mb-2">Disclosure of Your Personal Data</h3>
    <h4 class="text-xl font-semibold mt-4 mb-2">Business Transactions</h4>
    <p class="mb-4">
    ...
    <h4 class="text-xl font-semibold mt-4 mb-2">Law enforcement</h4>
    <p class="mb-4">
    ...
    <h4 class="text-xl font-semibold mt-4 mb-2">Other legal requirements</h4>
    <p class="mb-4">
    ...
    <h3 class="text-2xl font-semibold mt-6 mb-2">Security of Your Personal Data</h3>
    <p class="mb-4">
    ...
    <h2 class="text-3xl font-semibold mt-6 mb-4">Children's Privacy</h2>
    <p class="mb-4">
    ...
    <h2 class="text-3xl font-semibold mt-6 mb-4">Links to Other Websites</h2>
    <p class="mb-4">
    ...
    <h2 class="text-3xl font-semibold mt-6 mb-4">Changes to this Privacy Policy</h2>
    <p class="mb-4">
    ...
    <h2 class="text-3xl font-semibold mt-6 mb-4">Contact Us</h2>
    <p class="mb-4">
      If you have any questions about this Privacy Policy, You can contact us:
    </p>
    <ul class="list-disc list-inside mb-4">
      <li class="mb-2">By email: info@commite.dev</li>
      <li class="mb-2">
        By visiting this page on our website:
        <a
          href="http://www.commite.dev/contact"
          rel="external nofollow noopener"
          target="_blank"
          class="text-blue-600 hover:underline"
          >http://www.commite.dev/contact</a
        >
      </li>
    </ul>
  </div>
